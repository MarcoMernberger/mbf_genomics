...
module_dir = os.path.join(__location__, "../src/mbf_genomics")
try:
...
try:
    from mbf_genomics import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'mbf_genomics-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_genomics Documentation',
...
def setup(app):
    ...
    github_doc_root = "https://github.com/TyberiusPrime/mbf_genomics"
